<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Small%20Claims%20Statement%20G&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Small Claims Statement Generator Header Banner" />

  <h1>🚀 Small Claims Statement Generator</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/Small-Claims-Statement-Generator"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
```bash
git clone https://github.com/hsinidev/Small-Claims-Statement-Generator.git
cd Small-Claims-Statement-Generator
```
